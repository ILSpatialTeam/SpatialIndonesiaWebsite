...
export const PLANETS = [
  ...
  { id: 'karya', label: 'Showcase', orbit: 15.5, size: 0.98, color: ACCENT, speed: 0.062, phase: 2.1, skin: 'venus', tilt: 0.05 },
  ...
  { id: 'tim', label: 'Team', orbit: 30, size: 1.5, color: PAPER, speed: 0.03, phase: 1.2, skin: 'jupiter', tilt: 0.05 },
  { id: 'gabung', label: 'Join', orbit: 35.5, size: 1.3, color: ACCENT, speed: 0.024, phase: 3.3, skin: 'saturn', tilt: 0.47, ring: true }
];
...
const SKY = [
  ...
  {
    id: 'kalajengking', name: 'Kalajengking', note: 'Scorpius · the curving tail',
  ...
  {
    id: 'biduk', name: 'Biduk', note: 'Ursa Major · the boat in the north',
...
export const NAV = [{ id: 'inti', label: 'Core — Vision & Mission' }].concat(PLANETS.map(p => ({ id: p.id, label: p.label })));
